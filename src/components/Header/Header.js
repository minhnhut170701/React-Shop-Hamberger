      ...
      <div className='relative max-w-full'>
        ...
        {/* banner */}
          <AutoplaySlider
            ...
            >
            <div data-src={img1} className="relative z-50 flex flex-col items-center space-y-10">
            ...
            <div data-src={img2} className="relative z-50 flex flex-col items-center space-y-10">
                <p className='color-text font-bold text-xl md:text-6xl'>Good Time Great Taste.</p>
                <p className='color-text font-bold md:text-4xl text-xl'>Enjoy the food you love <span className='text-yellow-500'>FROM $6.99</span></p>
            </div>
            <div data-src={img3} className="relative z-50 flex flex-col items-center space-y-10">
                <p className='color-text font-bold text-xl md:text-6xl'>Good Time Great Taste.</p>
                <p className='color-text font-bold md:text-4xl text-xl'>Enjoy the food you love <span className='text-yellow-500'>FROM $6.99</span></p>
            </div>
         </AutoplaySlider>
